...
# A real import preserves arbitrary fields, backs up old bytes, produces BOM-free schema v5,
...
Assert-Equal $merged.schemaVersion 5 'schema upgraded'
...
Assert-Equal $minimal.schemaVersion 5 'minimal slot 3 created'
