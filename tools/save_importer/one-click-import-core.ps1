...
function Merge-ModSaveObject {
    ...
    $Existing | Add-Member -MemberType NoteProperty -Name schemaVersion -Value 4 -Force
...
function Assert-StagedModSave {
    ...
    if ([int]$data.schemaVersion -ne 4 -or [int]$data.achievementImport.formatVersion -ne 1 -or
