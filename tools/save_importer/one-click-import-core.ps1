...
function Merge-ModSaveObject {
    ...
    $Existing | Add-Member -MemberType NoteProperty -Name schemaVersion -Value 8 -Force
...
function Assert-StagedModSave {
    ...
    if ([int]$data.schemaVersion -ne 8 -or [int]$data.achievementImport.formatVersion -ne 1 -or
