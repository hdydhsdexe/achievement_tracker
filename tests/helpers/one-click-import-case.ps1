...
# A real import preserves arbitrary fields, backs up old bytes, produces BOM-free schema v6,
...
Assert-Equal $merged.schemaVersion 6 'schema upgraded'
...
Assert-Equal $minimal.schemaVersion 6 'minimal slot 3 created'
